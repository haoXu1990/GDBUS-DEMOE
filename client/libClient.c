...
static GatewayCnRTplayGdbusExample *pProxy = NULL;
...
static gboolean My_Signal_1_Handler(GatewayCnRTplayGdbusExample *object, const gchar *arg, gpointer userdata);
static gboolean My_Signal_2_Handler(GatewayCnRTplayGdbusExample *object,  GVariant *arg, gpointer userdata);
static void cb_OwnerNameChangedNotify(GObject *object, GParamSpec *pspec, gpointer userdata);
static bool registerClientSignalHandler(GatewayCnRTplayGdbusExample *pProxy);
...
bool registerClientSignalHandler(GatewayCnRTplayGdbusExample *pProxy)
{
...
static void MethodCallback_1(GObject* source_object, GAsyncResult* res, gpointer userdata)
{
    ...
    gateway_cn_rtplay_gdbus_example_call_my_method1_finish(pProxy, &out_arg, res, &pError);
...
void myMethodAsync_1(const char* in_arg)
{
    ...
    gateway_cn_rtplay_gdbus_example_call_my_method1(pProxy, in_arg, NULL, MethodCallback_1, NULL);
    return;
}

void myMethod_1(const gchar *in_arg, gchar** out_arg, GError** pError)
{
    gateway_cn_rtplay_gdbus_example_call_my_method1_sync(pProxy, in_arg, out_arg, NULL, pError);
...
static void MethodCallback_2(GObject* source_object, GAsyncResult* res, gpointer user_data)
{
    ...
    gateway_cn_rtplay_gdbus_example_call_my_method2_finish(pProxy, &out_arg, res, &pError);
    if (NULL == pError) {
...
void myMethodAsync_2(const gint in_arg1, const gint in_arg2)
{
    ...
    gateway_cn_rtplay_gdbus_example_call_my_method2(pProxy, in_arg, NULL, MethodCallback_2, NULL);
...
void myMethod_2(const gint in_arg1, const gint in_arg2, gchar **out_arg1, gint *out_arg2, GError** pError)
{
    ...
    gateway_cn_rtplay_gdbus_example_call_my_method2_sync(pProxy, in_arg, &out_arg, NULL, pError);
    if(NULL == *pError) {
...
bool InitDBusCommunication(void)
{
    ...
    do {
        ...
        if (NULL == pConnError) {
            ...
            pProxy = gateway_cn_rtplay_gdbus_example_proxy_new_sync(pConnection,
