...
static GatewayCnRTplayGdbusExample *pSkeleton = NULL;
...
static gboolean Emit_My_signal1(gconstpointer p)
{
    ...
    gateway_cn_rtplay_gdbus_example_emit_my_signal1(pSkeleton, buf);
...
static gboolean Emit_My_Signal2(gconstpointer p)
{
    ...
    gateway_cn_rtplay_gdbus_example_emit_my_signal2(pSkeleton, payload);

    return TRUE;
}

static gboolean My_Method1(GatewayCnRTplayGdbusExample     *object,
                           ...
                           gpointer               user_data)
{
    ...
    gateway_cn_rtplay_gdbus_example_complete_my_method1(object, invocation, in_arg);

    return TRUE;
}

static gboolean My_Method2(GatewayCnRTplayGdbusExample     *object,
                           GDBusMethodInvocation *invocation,
                           GVariant           *in_arg,
                           gpointer               user_data)
{
    ...
    gateway_cn_rtplay_gdbus_example_complete_my_method2(object, invocation, out_arg);
                            ...
                            gpointer         user_data)
{
    ...
    pSkeleton = gateway_cn_rtplay_gdbus_example_skeleton_new();
