...
static gboolean My_Method1(GatewayCnRTplayGdbusExample* object, GDBusMethodInvocation* invocation, const gchar* in_arg, gpointer user_data);
static gboolean My_Method2(GatewayCnRTplayGdbusExample* object, GDBusMethodInvocation* invocation, GVariant* in_arg, gpointer user_data);
